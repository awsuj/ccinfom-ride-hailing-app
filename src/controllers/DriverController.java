...
public class DriverController {
     ...
     */
    public void init(ViewHandler viewHandler, DriverDAO driverDAO, VehicleDAO vehicleDAO, TransactionDAO transactionDAO) {
    ...
    private void populateRideDetails() {
        ...
        if (ride != null) {
            ...
            // passengerNameValue.setText(...); // Need to fetch passenger name
    ...
    void onLoginClicked(ActionEvent event) {
        ...
        if (d != null && d.checkPassword(password)) {
            ...
            // Fetch related data
            currentDriver.setVehicles((ArrayList<Vehicle>) vehicleDAO.findByDriver(d.getDriverID()));
            ...
            // TODO: Find the ONGOING transaction and set it
    ...
    // TODO: Implement other button handlers (change password, view vehicles, etc.)
}